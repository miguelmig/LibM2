...
namespace libm2 {
    namespace Addr {
        ...
        namespace quest {
            ...
            enum class PC {
                SetCurrentQuestCounterValue = 0x81DAE20, // quest::PC::SetCurrentQuestCounterValue(int)
                SendFlagList = 0x81DDCD0, // quest::PC::SendFlagList(CHARACTER *)
                RemoveTimer = 0x81DBB30, // quest::PC::RemoveTimer(std::string  const&)
                SetCurrentQuestClockValue = 0x81DADD0, // quest::PC::SetCurrentQuestClockValue(int)
                CancelRunning = 0x81DAC80, // quest::PC::CancelRunning(void)
                AddQuestStateChange = 0x81DB1C0, // quest::PC::AddQuestStateChange(std::string  const&,int,int)
                AddTimer = 0x81DCED0, // quest::PC::AddTimer(std::string  const&,boost::intrusive_ptr<event>)
                PC__26251 = 0x81DE550, // quest::PC::PC(void)
                GiveExp = 0x81DD4A0, // quest::PC::GiveExp(std::string  const&,unsigned int)
                ClearTimer = 0x81DC560, // quest::PC::ClearTimer(void)
                SendQuestInfoPakcet = 0x81DB350, // quest::PC::SendQuestInfoPakcet(void)
                RemoveTimerNotCancel = 0x81DB8A0, // quest::PC::RemoveTimerNotCancel(std::string  const&)
                GetCurrentQuestIndex = 0x81DB6C0, // quest::PC::GetCurrentQuestIndex(void)
                SetCurrentQuestClockName = 0x81DB7C0, // quest::PC::SetCurrentQuestClockName(std::string  const&)
                Save = 0x81DC630, // quest::PC::Save(void)
                SetCurrentQuestTitle = 0x81DB2F0, // quest::PC::SetCurrentQuestTitle(std::string  const&)
                SetCurrentQuestStartFlag = 0x81DAF60, // quest::PC::SetCurrentQuestStartFlag(void)
                GetFlag = 0x81DB820, // quest::PC::GetFlag(std::string  const&)
                SetCurrentQuestStateName = 0x81DC230, // quest::PC::SetCurrentQuestStateName(std::string  const&)
                SetSendFlag = 0x81DACC0, // quest::PC::SetSendFlag(int)
                SaveFlag = 0x81DB990, // quest::PC::SaveFlag(std::string  const&,int)
                GiveItem = 0x81DD8B0, // quest::PC::GiveItem(std::string  const&,unsigned int,int)
                PC = 0x81D1B60, // quest::PC::PC(quest::PC const&)
                GetQuest = 0x81E05C0, // quest::PC::GetQuest(std::string  const&)
                HasQuest = 0x81DB700, // quest::PC::HasQuest(std::string  const&)
                SetID = 0x81DAC20, // quest::PC::SetID(unsigned int)
                GetCurrentQuestName = 0x81DAC50, // quest::PC::GetCurrentQuestName(void)const
                GetCurrentQuestBeginFlag = 0x81DAD40, // quest::PC::GetCurrentQuestBeginFlag(void)
                SetCurrentQuestDoneFlag = 0x81DAD80, // quest::PC::SetCurrentQuestDoneFlag(void)
                SetCurrentQuestIconFile = 0x81DB290, // quest::PC::SetCurrentQuestIconFile(std::string  const&)
                DoQuestStateChange = 0x81DEDB0, // quest::PC::DoQuestStateChange(void)
                SetFlag = 0x81DBD50, // quest::PC::SetFlag(std::string  const&,int,bool)
                ClearCurrentQuestBeginFlag = 0x81DACF0, // quest::PC::ClearCurrentQuestBeginFlag(void)
                Reward = 0x81DB000, // quest::PC::Reward(CHARACTER *)
                SetQuest = 0x81E0080, // quest::PC::SetQuest(std::string  const&,quest::QuestState &)
                SetCurrentQuestBeginFlag = 0x81DAF00, // quest::PC::SetCurrentQuestBeginFlag(void)
                Destroy = 0x81DC600, // quest::PC::Destroy(void)
                SetCurrentQuestCounterName = 0x81DB760, // quest::PC::SetCurrentQuestCounterName(std::string  const&)
                DeleteFlag = 0x81DBA90, // quest::PC::DeleteFlag(std::string  const&)
                EndRunning = 0x81DF8F0, // quest::PC::EndRunning(void)
                ClearQuest = 0x81DDF60, // quest::PC::ClearQuest(std::string  const&)
                SetQuestTitle = 0x81DC2F0, // quest::PC::SetQuestTitle(std::string  const&,std::string  const&)
                Build = 0x81DEA30, // quest::PC::Build(void)
            };
        }
        enum class DESC {
        ...
        namespace building {
            enum class CManager {
                singleton = 0x86A36BC,
                SendLandList = 0x8066140, // building::CManager::SendLandList(DESC *,long)
                FindObjectByVID = 0x8065990, // building::CManager::FindObjectByVID(unsigned int)
                LoadObject = 0x8068490, // building::CManager::LoadObject(building::SObject *,bool)
                FinalizeBoot = 0x80682F0, // building::CManager::FinalizeBoot(void)
                FindLand__4462 = 0x80658B0, // building::CManager::FindLand(long,long,long)
                Destroy = 0x80668D0, // building::CManager::Destroy(void)
                LoadLand = 0x8066A30, // building::CManager::LoadLand(building::SLand *)
                LoadObjectProto = 0x8065B40, // building::CManager::LoadObjectProto(building::SObjectProto  const*,int)
                GetObjectProto = 0x8064BF0, // building::CManager::GetObjectProto(unsigned int)
                CManager = 0x8068A50, // building::CManager::CManager(void)
                ClearLand = 0x8066640, // building::CManager::ClearLand(unsigned int)
                UnregisterObject = 0x8065F90, // building::CManager::UnregisterObject(building::CObject *)
                FindLandByGuild = 0x8066310, // building::CManager::FindLandByGuild(unsigned int)
                FindLand = 0x8064C40, // building::CManager::FindLand(unsigned int)
                DeleteObject = 0x80660C0, // building::CManager::DeleteObject(unsigned int)
                UpdateLand = 0x8065580, // building::CManager::UpdateLand(building::SLand *)
                ClearLandByGuildID = 0x80665B0, // building::CManager::ClearLandByGuildID(unsigned int)
            };
            enum class CLand {
                RequestCreateWall = 0x80673E0, // building::CLand::RequestCreateWall(long,float)
                FindObjectByVID = 0x8065E80, // building::CLand::FindObjectByVID(unsigned int)
                FindObjectByNPC = 0x8065AD0, // building::CLand::FindObjectByNPC(CHARACTER *)
                PutData = 0x8064DF0, // building::CLand::PutData(building::SLand  const*)
                CLand = 0x8066970, // building::CLand::CLand(building::SLand *)
                RequestDeleteWall = 0x8066770, // building::CLand::RequestDeleteWall(void)
                SetOwner = 0x8064DA0, // building::CLand::SetOwner(unsigned int)
                Destroy = 0x80663F0, // building::CLand::Destroy(void)
                RequestDeleteObjectByVID = 0x8065ED0, // building::CLand::RequestDeleteObjectByVID(unsigned int)
                InsertObject = 0x8066380, // building::CLand::InsertObject(building::CObject *)
                RequestDeleteObject = 0x8065DD0, // building::CLand::RequestDeleteObject(unsigned int)
                FindObjectByGroup = 0x8065A60, // building::CLand::FindObjectByGroup(unsigned int)
                RequestUpdate = 0x8064D20, // building::CLand::RequestUpdate(unsigned int)
                ClearLand = 0x80664B0, // building::CLand::ClearLand(void)
                RequestCreateObject = 0x8066D30, // building::CLand::RequestCreateObject(unsigned int,long,long,long,float,float,float,bool)
                FindObject = 0x8065D80, // building::CLand::FindObject(unsigned int)
                GetData = 0x8064BC0, // building::CLand::GetData(void)
                FindObjectByVnum = 0x8065840, // building::CLand::FindObjectByVnum(unsigned int)
                RequestDeleteWallBlocks = 0x80666D0, // building::CLand::RequestDeleteWallBlocks(unsigned int)
                DrawWall = 0x8067A60, // building::CLand::DrawWall(unsigned int,long,long &,long &,char,float)
                RequestCreateWallBlocks = 0x8067BF0, // building::CLand::RequestCreateWallBlocks(unsigned int,long,char,bool,bool,bool,bool)
                DeleteObject = 0x8066000, // building::CLand::DeleteObject(unsigned int)
            };
            enum class CObject {
                SetVID = 0x8064B60, // building::CObject::SetVID(unsigned int)
                ApplySpecialEffect = 0x8065000, // building::CObject::ApplySpecialEffect(void)
                Show = 0x8065100, // building::CObject::Show(long,long,long)
                RemoveSpecialEffect = 0x8064F60, // building::CObject::RemoveSpecialEffect(void)
                RegenNPC = 0x8067F80, // building::CObject::RegenNPC(void)
                CObject = 0x8065440, // building::CObject::CObject(building::SObject *,building::SObjectProto *)
                EncodeInsertPacket = 0x8065730, // building::CObject::EncodeInsertPacket(CEntity *)
                Destroy = 0x8065250, // building::CObject::Destroy(void)
                Save = 0x8064B90, // building::CObject::Save(void)

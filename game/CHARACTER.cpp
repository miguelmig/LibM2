...
namespace libm2 {
    ...
    bool CHARACTER::GiveItemFromSpecialItemGroup(DWORD dwGroupNum, std::vector<unsigned int, std::allocator<unsigned int> > & dwItemVnums, std::vector<unsigned int, std::allocator<unsigned int> > & dwItemCounts, std::vector<CItem*, std::allocator<CItem*> > & item_gets, int & count) {
        return ((bool(*)(CHARACTER * const, DWORD, std::vector<unsigned int, std::allocator<unsigned int> > &, std::vector<unsigned int, std::allocator<unsigned int> > &, std::vector<CItem*, std::allocator<CItem*> > &, int &))Addr::CHARACTER::GiveItemFromSpecialItemGroup__DWORD_std_vector_unsigned_int_std_allocator_unsigned_int__std_vector_unsigned_int_std_allocator_unsigned_int__std_vector_CItem_std_allocator_CItem__int_)(this, dwGroupNum, dwItemVnums, dwItemCounts, item_gets, count);
    }
    ...
    bool CHARACTER::Show(long lMapIndex, long x, long y, long z, bool bShowSpawnMotion) {
        return ((bool(*)(CHARACTER * const, long, long, long, long, bool))Addr::CHARACTER::Show__long_long_long_long_bool)(this, lMapIndex, x, y, z, bShowSpawnMotion);
    }

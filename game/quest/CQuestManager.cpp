...
namespace libm2{
namespace quest{
void CQuestManager::AddLuaFunctionTable(const char * name, luaL_reg * preg) {
	((void(*)(quest::CQuestManager *, const char *, luaL_reg *))Addr::quest::CQuestManager::AddLuaFunctionTable)(this, name, preg);
}
